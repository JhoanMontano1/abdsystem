...
<td> <button class='btn btn-sm btn-danger delete'>Eliminar</button></td>
   ...
   $('#factura Tbody').html(facturaHtml);
    ...
    else{alert('La cantidad ingresada supera la cantidad en stock');}
...
else{alert('La cantidad ingresada super al stock del productos')}
...
$.ajax({
  ...
  success: function(data) {
    ...
    }else{alert('La lista de elementos esta vacia')}
